...
import NodeTest, { describe, mock } from 'node:test';
...
// TODO: This test was not enabled. When it is enabled, it is failing.
describe.skip('fix this test', () => {
  scenario(
    ...
    bdd => {
      bdd
        ...
        .then('textContent should match', (_, { container }) =>
          expect(container).toHaveProperty('textContent', 'Aloha!')
        )
